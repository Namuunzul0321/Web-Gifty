...
export default function StoreButton({
  ...
  return (
    <Link href={link}>
      <div className="w-[184px] h-[242px] border border-[#6D5B67] rounded-[10px] cursor-pointer transition duration-150ms hover:shadow-[0_5px_15px_rgba(0,0,0,0.2)] active:shadow-[0_2px_7px_rgba(0,0,0,0.2)] ${className} max-md:w-[140px] max-md:h-[184.1px] max-sm:w-[100px] max-sm:h-[131.5px]">
