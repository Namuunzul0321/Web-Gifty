...
export default function ProductButtonSpecial({
  ...
  return (
    <Link href={link}>
        <div className="w-[767px] h-[443px] border border-[#6D5B67] rounded-[10px] overflow-hidden relative cursor-pointer transition duration-150ms hover:shadow-[0_5px_15px_rgba(0,0,0,0.5)] active:shadow-[0_2px_7px_rgba(0,0,0,0.2)] max-md:w-[650px] max-sm:w-[400px]">
            ...
            <div className="w-full h-[379.3px] border-t border-t-[#6D5B67] flex justify-center items-center">
                ...
                <div className="w-[767px] h-[120px] pt-[45px] pl-[15px] pr-[15px] text-white self-end bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.47)_53%,rgba(0,0,0,0.8)_100%)] absolute max-md:w-[650px] max-sm:w-[400px]">
